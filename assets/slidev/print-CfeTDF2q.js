import{d as _,P as u,z as h,f as n,g as t,t as s,B as r,F as f,Q as g,o as l,i as v,e as x,E as b}from"../modules/vue-ElOxmkUr.js";import{l as k,k as y,c as m}from"../index-BygrV_tq.js";import{_ as N}from"./NoteDisplay.vue_vue_type_style_index_0_lang-DTbQauPL.js";import"../modules/shiki-JTWoPtEB.js";const w={id:"page-root"},B={class:"m-4"},L={class:"mb-10"},T={class:"text-4xl font-bold mt-2"},V={class:"opacity-50"},H={class:"text-lg"},S={class:"font-bold flex gap-2"},z={class:"opacity-50"},C={key:0,class:"border-main mb-8"},j=_({__name:"print",setup(D){const{slides:d,total:p}=k();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
